...
def reset_calls
  ...
  MethodCallCheck::Store.client.del("method_call_check:instance_methods:counts:MixinTestModule::mixin_method_to_test")
  MethodCallCheck::Store.client.del("method_call_check:instance_methods:calls:MethodCallCheckTest::TestObject::method_to_test")
  MethodCallCheck::Store.client.del("method_call_check:instance_methods:calls:MixinTestModule::mixin_method_to_test")
...
def reset_registrations
  ...
  MethodCallCheck::Store.client.del("method_call_check:instance_methods:registered_at:MixinTestModule::mixin_method_to_test")
