...
class MethodCallCheckTest < Minitest::Test
  ...
  def test_method_registered
    ...
    assert_includes (Time.now.to_i - 10)..(Time.now.to_i), MethodCallCheck::Store.instance.instance_method_registered_at(:method_to_test)
  end
  ...
  def test_method_called
    ...
    assert_equal 1, MethodCallCheck::Store.instance.stored_instance_method_call_count(:method_to_test)
  end
  ...
  def test_method_called_multiple_times
    ...
    assert_equal 6, MethodCallCheck::Store.instance.stored_instance_method_call_count(:method_to_test)
  end
